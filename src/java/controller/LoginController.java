...
public class LoginController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            // get parameter email and password
            String txtEmail = request.getParameter("txtEmail");
            String txtPassword = request.getParameter("txtPassword");

            UserDAO userDAO = new UserDAO();
            User user = new User();
            // add 2 parameter in Contructer
            ...
            // check role is not null or empty. here not divide page ADMIN or USER 
            if (!role.equals("")) {
                ...
                request.setAttribute("LOGIN_MSG", "Wrong username/password please check again!!");
            }
        } catch (Exception e) {
