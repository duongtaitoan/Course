<%-- 
    Document   : mentor_details.jsp
    Created on : Apr 26, 2022, 8:54:42 PM
    Author     : duong
--%>
...
<html>
    <head>
        ...
        <title>Mentor Details page</title>
        <style>
    ...
    <body>
            ...
            <div id="demo" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner mt-1">
                    <div class="carousel-item active">
                        <a href="card.jsp">
                            <!--<img src="https://images.alphacoders.com/298/298721.jpg">-->
                            <img src="https://bizuni.vn/upload/images/Slide/bo-khoa-hoc.webp?v=1639971613">
                        </a>
                    </div>
                    <div class="carousel-item">
                        <a href="card.jsp">
                            <img src="https://bizuni.vn/upload/images/Slide/slide%20dau-tu-co-phieu-dai-han.webp?v=1639971633">
                        </a>
                    </div>
                    <div class="carousel-item">
                        <a href="card.jsp">
                            <img  src="https://bizuni.vn/upload/images/Slide/tuyet-dinh-dam-phan.webp?v=1582193187">
                        </a>
                    </div>
                </div>
        ...
        <div class="row pe-5 ps-5 mb-5">
            <c:if test="${MENTOR_DETAILS != null}">
                <c:if test="${not empty MENTOR_DETAILS}">
                    <c:forEach items="${MENTOR_DETAILS}" var="mentor">
                        <h3 class="text-center mt-5">${mentor.working}</h3>
                        <hr class="col-md-3 offset-md-3 w-50"/>
                        <div class="card pt-2 pe-5 ps-5 container" style="border: none">
                            <div class="row container pe-5 ps-5">
                                <div class="col-3 col-sm-7">
                                    <strong class="pt-5 pe-5 ps-5 pb-5"><h2> ${mentor.mentorName} </h2> </strong>
                                    <p>${mentor.description}</p>
                                </div>
                                <div class="col-3 col-sm-5 pt-4 text-center">
                                    <img src="${mentor.image}" alt="" class="w-75 img-fluid img-thumbnail">
                                    <h4 class="pt-2">${mentor.mentorName}
                                        <hr class="col-md-3 offset-md-3 w-50"/>
                                    </h4>
                                    <div class="row ps-3">
        ...
        <hr class="col-md-2 offset-md-2 w-75"/>
        <!--list course of this mentor-->
        <div class="row mb-5">
            <div class="text-center">
                <strong><h2>Những khóa học do giảng viên ${NAME_MENTOR} giảng dạy</h2></strong>
            </div>
            <div class="row pe-5 ps-5 pb-5">
                <c:if test="${LIST_COURSE_MENTOR != null}">
                    <c:if test="${not empty LIST_COURSE_MENTOR}">
                        <c:forEach items="${LIST_COURSE_MENTOR}" var="course">
                            <div class="col-lg-3 col-md-6 mt-5 mb-4 pe-4 ps-4 mb-lg-0">
                                <div class="card rounded shadow-sm border-1">
                                    <div class="card pt-3 nav-link active">
                                        <a style="text-decoration: none; color: black" href="card.jsp">
                                            <img src="${course.image}" alt="" class="img-fluid d-block mx-auto mb-3">
                                            <h5>${course.description}</h5>
                                            <div class="row">
                                                <div class="row">
                                                    <div class="col-6"><strong>${COUNT_MENTOR}</strong> Môn Học</div>
                                                    <div class="col-6"><i class="fa-solid fa-timer"></i> <strong>${course.lesson.timeLesson}</strong> Giờ học</div>
